...
AS
INSERT INTO TB_PRELOAD_MTR (ID_TBCLIENT,ID_TBCLZONE,ID_TBINCODEMTR,DOC_ENTRY,STATE_PRELOAD,NUM_SERIAL,MARK,NAME_MODEL) VALUES (@ID_TBCLIENT,@ID_TBCLZONE,@ID_TBINCODEMTR,@DOC_ENTRY,0,@NUM_SERIAL,@MARK,@NAME_MODEL);
GO 
...
CREATE PROCEDURE SP_create_doc_entry
@CODIGO VARCHAR (50)
AS
