...
--Sentencia para cargar el filtro documentos entrada actualizar
CREATE PROCEDURE SP_documentos_entrada_actualizar
@USUARIO INT,
@DOC_ENTRADA varchar(20),
@NUM_SERIAL varchar(20),
@GRUPO varchar(10),
...
SET @SQL_SENTENCIA = 'SELECT DOC_ENTRY FROM TB_GROUP
INNER JOIN (TB_DEVICES INNER JOIN TB_ACTY_MTR ON TB_DEVICES.ID_TBDEVICES = TB_ACTY_MTR.ID_TBDEVICES) 
ON TB_GROUP.ID_TBGROUP =  TB_DEVICES.ID_TBGROUP 
WHERE ID_TBCLIENT = ' + CONVERT(VARCHAR,@USUARIO) + @condiciones
EXEC (@SQL_SENTENCIA)
...
--Sentencia para eliminar SP_numero_serial
DROP PROCEDURE SP_documentos_entrada_actualizar

--Sentencia para CREAR procedimiento SP_consulta_actualizar
CREATE PROCEDURE SP_numero_serial_actualizar
@USUARIO INT,
@DOC_ENTRADA varchar(20),
@NUM_SERIAL varchar(20),
@GRUPO varchar(10),
...
SET @SQL_SENTENCIA = 'SELECT NUM_SERIAL FROM TB_GROUP
INNER JOIN (TB_DEVICES INNER JOIN TB_ACTY_MTR ON TB_DEVICES.ID_TBDEVICES = TB_ACTY_MTR.ID_TBDEVICES) 
ON TB_GROUP.ID_TBGROUP =  TB_DEVICES.ID_TBGROUP 
WHERE ID_TBCLIENT = ' + CONVERT(VARCHAR,@USUARIO) + @condiciones
EXEC (@SQL_SENTENCIA)
...
--Sentencia para eliminar SP_numero_serial
DROP PROCEDURE SP_numero_serial_actualizar

--Sentencia para CREAR procedimiento SP_consulta_actualizar
CREATE PROCEDURE SP_grupo_actualizar
@USUARIO INT,
@DOC_ENTRADA varchar(20),
@NUM_SERIAL varchar(20),
@GRUPO varchar(10),
...
SET @SQL_SENTENCIA = 'SELECT NAME_GROUP FROM TB_GROUP
INNER JOIN (TB_DEVICES INNER JOIN TB_ACTY_MTR ON TB_DEVICES.ID_TBDEVICES = TB_ACTY_MTR.ID_TBDEVICES) 
ON TB_GROUP.ID_TBGROUP =  TB_DEVICES.ID_TBGROUP 
WHERE ID_TBCLIENT = ' + CONVERT(VARCHAR,@USUARIO) + @condiciones
EXEC (@SQL_SENTENCIA)
...
--Sentencia para eliminar SP_numero_serial
DROP PROCEDURE SP_grupo_actualizar